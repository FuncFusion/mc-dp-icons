...
**Highlight your most important functions!** The extension includes three special crowned command block icons (<sub><img src="icons/mcfunction_file_crowned.svg" width="18"></sub> <sub><img src="icons/mcfunction_load_file_crowned.svg" width="18"></sub> <sub><img src="icons/mcfunction_tick_file_crowned.svg" width="18"></sub>) to help you visually prioritize specific files. Add your chosen file names to the settings to apply these icons. Wildcards are also supported (e.g., `core_*` or `*helper*`).
