...
Namespace folders (folders directly within <img src="icons/data_folder_closed.svg" width="18"> `data` and <img src="icons/assets_folder_closed.svg" width="18"> `assets`) will change their icons to <img src="icons/namespace_folder_closed.svg" width="18"> ender chests. This works only if there is a <sub><img src="icons/pack.mcmeta_file.svg" width="18"></sub> `pack.mcmeta` file in the same directory.
